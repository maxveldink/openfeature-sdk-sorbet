...
class NoOpProviderTest < Minitest::Test
  ...
  def test_resolve_boolean_value_returns_given_default
    assert_equal(
      OpenFeature::ResolutionDetails.new(value: true, reason: "DEFAULT"),
  ...
  def test_resolve_string_value_returns_given_default
    assert_equal(
      OpenFeature::ResolutionDetails.new(value: "A Test Value", reason: "DEFAULT"),
  ...
  def test_resolve_number_value_returns_given_default
    assert_equal(
      OpenFeature::ResolutionDetails.new(value: 4.3, reason: "DEFAULT"),
  ...
  def test_resolve_structure_value_returns_given_default
    assert_equal(
      OpenFeature::ResolutionDetails.new(value: { "testing" => "123" }, reason: "DEFAULT"),
